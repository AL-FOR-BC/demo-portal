...
const ApproveTrainingRequest: React.FC = () => {
  ...
  const {
    ...
    isFieldDisabled,
    trainingRoomOptions,
  } = useTrainingRequest({ mode: "approve", systemId: id });
  ...
  return (
    <HeaderMui
      ...
      subtitle="Approve Training Request"
...
export default ApproveTrainingRequest;

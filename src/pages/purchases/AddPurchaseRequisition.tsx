...
function AddPurchaseRequisition() {
  ...
  const handleSubmit = async () => {
    try {
      ...
      console.log(
        "expectedReceiptDate",
        formatDate(expectedReceiptDate[0] as string)
      );
      /* Submit logic */
      const data: PurchaseRequisitionType = {
        ...
        locationCode:
          selectedLocation.length > 0 ? selectedLocation[0].value : "",
        procurementDescription: subjectOfProcurement,
        // budgetCode: budgetCode,
        // check if it an array
        expectedReceiptDate: Array.isArray(expectedReceiptDate)
          ? formatDate(expectedReceiptDate[0].toISOString())
          : formatDate(expectedReceiptDate.toISOString()),

...
import {
  EyeIcon,
  EyeInvisibleIcon,
} from "../../Components/common/icons/icons.tsx";
            ...
            <Col md={8} lg={6} xl={5}>
              <Card className="overflow-hidden">
                <div className="bg-primary bg-soft">
                  <Row>
                    <Col xs={7}>
                      <div className="p-4" style={{ color: themeColor }}>
                        <h5 style={{ color: themeColor }}>Welcome Back !</h5>
                        <p>Sign in to continue to EHub.</p>
                      </div>
                    </Col>
                    <Col className="col-4 align-self-end px-2">
                      <img
                        src={companyLogo || romLogo}
                        alt="Company Logo"
                        className="img-fluid"
                  ...
                  <div className="p-2">
                    ...
                    <div className="mt-4 text-center align-items-center">
                      <Link to="/register" className="text-muted">
                        ...
                        <span style={{ color: themeColor }}>Register</span>
                      </Link>
                    </div>
                    <div className="mt-4 text-center align-items-center">
